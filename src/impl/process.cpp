...
auto
impl::msvc_process::internal_detach() noexcept -> void
{
    if (has_valid_handle()) {
        CloseHandle(handle_);
    }
...
auto
impl::msvc_process::detect_architecture() noexcept -> bool
{
...
impl::msvc_process::~msvc_process()
{
    internal_detach();
}

auto
impl::msvc_process::attach(
...
auto
impl::msvc_process::detach() noexcept -> void
{
    internal_detach();
}

auto
impl::msvc_process::get_image(
    const std::string_view name,
